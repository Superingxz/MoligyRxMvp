package com.moligy.demo.mvp.ui.fragment;
...
import com.moligy.demo.di.component.DaggerShopCartComponent;
import com.moligy.demo.di.module.ShopCartModule;
import com.moligy.demo.mvp.contract.ShopCartContract;
import com.moligy.demo.mvp.presenter.ShopCartPresenter;
...
public class ShopCartFragment extends BaseFragment<ShopCartPresenter> implements ShopCartContract.View {
    ...
    public void setupFragmentComponent(AppComponent appComponent) {
        DaggerShopCartComponent //如找不到该类,请编译一下项目
                .builder()
